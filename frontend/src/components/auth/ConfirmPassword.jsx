...
const ConfirmPassword = () => {
  ...
  const handleSubmit = async (e)=>{
    ...
    if(password.password1.trim().length < 8){
      return useNotification.updateNotification('error', 'Password have to be 8 characters long')
    }
    if(password.password1 !== password.password2){
      return useNotification.updateNotification('error', 'Password in both fields have to be same')
    }
